...
### Q Atlantis `chore/npm-audit-and-sakura-deploy`

- `7ee3cce`: Atlantis World Builder、World／Object／Action 3D Fold、World causality、MAGI／Flavor SDK接続票
- `fe7ce0b`: Manifest正本候補のrevision固定受領台帳
- runtime、OAE Schema、MAGI sidecar emitterは未実装として維持
