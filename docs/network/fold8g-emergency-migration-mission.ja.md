...
2026-09-11 追記: `https://quantaril.cloud/` は引き続き DEAD。生成元ソースは [HIPSTAR-IScompany/quantaril_cloud_QAtlantis](https://github.com/HIPSTAR-IScompany/quantaril_cloud_QAtlantis) から見える。現状メモ: [../preservation/quantaril-domain-status.ja.md](../preservation/quantaril-domain-status.ja.md)
