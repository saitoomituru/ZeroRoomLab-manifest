...
| 2013 | Designed and operated a one-person generative studio pipeline spanning pre-production, Blender-based production, Adobe/ComicStudio post-production, and doujin publication. It integrated credited third-party city/tree generators without transferring authorship of those components; uncertainty about a separate proprietary number-theory engine does not erase the evidenced pipeline or shipped work. |
