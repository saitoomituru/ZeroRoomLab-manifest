...
| 2013 | Assembled a generative production pipeline spanning Blender, third-party city/tree generators, asset libraries, and Adobe/ComicStudio-era manuscript work. The recovered evidence confirms the integration lineage, but not a single proprietary number-theory engine. |
